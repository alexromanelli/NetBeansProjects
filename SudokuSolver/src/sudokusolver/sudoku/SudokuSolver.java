...
import sudokusolver.console.SudokuConsoleView;
...
public class SudokuSolver {
     ...
     *
     * @param inicio matriz 9x9 de caracteres, que representa a configuração
     ...
     * de chamadas recursivas. Basicamente, o fluxo de ações deste método
     * é:<br/>
     * <ul>
     ...
     * inviável);</li>
     * <li>Identifica as conjecturas que podem ser feitas para o estado
     * atual;</li>
     ...
     * </ul>
     *
     * @param t o tabuleiro atual do jogo (matriz 9x9 de caracteres)
     * @param numCelulasLivres o número de células não preenchidas do tabuleiro
     * do jogo
     * @return uma matriz 9x9 de caracteres que representa a configuração final
    ...
    private boolean tabInvalidoConhecido(Celula[][] tab) {
        ...
        loopInvalidos:
        for (char[] inv : ESTADOS_INVALIDOS) {
            for (int i = 0; i < 81; i++) {
     ...
     *
     * @param tab o estado atual do tabuleiro
     * @param conjecturas a coleção que armazenará as conjecturas identificadas
     */
     ...
     * </ol>
     *
     * @param tab a matriz 9x9 de células que representa o tabuleiro do jogo.
     */
